...
export default function BackToTop({ label, threshold = 600 }) {
  ...
  return (
    <button
      ...
      onClick={toTop}
      aria-label={label}
      className="fixed bottom-5 right-5 z-[80] inline-flex h-10 w-10 items-center justify-center rounded-full bg-white/80 backdrop-blur-xl ring-1 ring-slate-900/[.1] text-slate-700 shadow-[0_8px_28px_-12px_rgba(15,23,42,.4)] hover:text-slate-900 hover:ring-cyan-500/30 transition animate-[fadeUp_.25s_ease-out]"
    >
