  ...
  return (
    <section className="min-h-[70vh] grid place-items-center px-6 py-24">
      <div className="text-center max-w-md">
        <div className="mx-auto mb-6 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-rose-50 text-rose-600 ring-1 ring-rose-500/15">
        ...
        <h1 className="font-display text-[clamp(1.6rem,3vw,2.2rem)] tracking-tight text-slate-900">
        ...
        <div className="mt-7 flex items-center justify-center gap-3">
          ...
          <Link
            to="/"
            onClick={onReset}
            className="inline-flex items-center gap-2 rounded-full px-5 py-3 text-[13.5px] font-medium text-slate-800 bg-white/70 border border-white/70 ring-1 ring-slate-900/[.06] hover:bg-white transition"
          >
            {tr ? 'Ana sayfa' : 'Home'}
          </Link>
        </div>
