// i18n namespace: contact (TR/EN). Split from the former monolithic
...
export default {
  "tr": {
    ...
    "nextSteps": [
      {
        "t": "24 saat içinde dönüş",
        "d": "Ekipten biri yazılı olarak cevap verir."
      },
      {
        "t": "Discovery görüşmesi",
        "d": "20 dakikalık online tanışma + kullanım senaryosu."
      },
      {
  ...
  "en": {
    ...
    "nextSteps": [
      {
        "t": "Reply within 24h",
        "d": "Someone from the team writes back."
      },
      {
        "t": "Discovery call",
        "d": "A 20-minute intro + your use case."
      },
      {
        "t": "Demo & pilot offer",
