...
export default function CookieBanner() {
  ...
  return (
    <div
      ...
      className="fixed bottom-3 left-3 right-3 sm:right-auto sm:max-w-md z-[80] rounded-2xl bg-white/95 backdrop-blur-xl border border-white/70 ring-1 ring-slate-900/[.08] shadow-[0_20px_60px_-20px_rgba(15,23,42,.35)] p-4 animate-[fadeUp_.32s_ease-out]"
    >
